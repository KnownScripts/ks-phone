...
RegisterNetEvent('qb-phone:server:wenmo_givemoney_toID', function(data)
    ...
    if Ply.PlayerData.money.bank >= Amount then
        ...
        if Config.RenewedBanking then
            ...
            exports['ks-pank']:handleTransaction(cid, "Wenmo Transaction", Amount, txt, name2, name, "withdraw")
            exports['ks-pank']:handleTransaction(cid2, "Wenmo Transaction", Amount, txt, name, name2, "deposit")
        end
    else
